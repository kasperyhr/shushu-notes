...
\pagecolor{white}
 ...
 \begin{tikzpicture}[scale=1.2]
   ...
   % 方位标注
   \node[font=\normalsize\bfseries, blue!60] at ( 90:2.8) {北};
   \node[font=\normalsize\bfseries, blue!60] at (270:2.8) {南};
   \node[font=\normalsize\bfseries, blue!60] at (  0:2.8) {东};
   \node[font=\normalsize\bfseries, blue!60] at (180:2.8) {西};
   ...
   % 季节标签
   \node[font=\small, green!60!black] at (90:1.4)  {春};
   \node[font=\small, red!60!black]   at (0:1.4)   {夏};
   \node[font=\small, orange!60!black] at (270:1.4) {秋};
   \node[font=\small, blue!60!black]  at (180:1.4) {冬};
 
   % 中心标签
   \node[font=\normalsize, gray] at (0,0) {十二地支};
