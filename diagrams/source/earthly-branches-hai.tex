 ...
 \begin{tikzpicture}[scale=1.2]
   ...
   % 六害：点划线
   \draw[purple!70!black, thick, dash dot] (zi)   -- (wei);
   \draw[purple!70!black, thick, dash dot] (chou) -- (wu);
   \draw[purple!70!black, thick, dash dot] (yin)  -- (si);
   \draw[purple!70!black, thick, dash dot] (mao)  -- (chen);
   \draw[purple!70!black, thick, dash dot] (shen) -- (hai);
   \draw[purple!70!black, thick, dash dot] (you)  -- (xu);
 
   % 图例
   \node[font=\footnotesize, purple!70!black, anchor=west] at (-5.5,-4.5) {六害：暗伤、隔阂、隐性损耗};
   \draw[purple!70!black, thick, dash dot] (-5.5,-4.2) -- (-4.8,-4.2);
 \end{tikzpicture}
 \end{document}
