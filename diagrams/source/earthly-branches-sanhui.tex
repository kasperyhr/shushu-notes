...
\begin{tikzpicture}[scale=1.35]
  ...
  % Labels: two separate nodes per direction with clear vertical gap
  \node[font=\normalsize\bfseries, blue!60!black]  at (90:2.8)  {北方水};
  \node[font=\normalsize\bfseries, blue!60!black]  at (90:2.0)  {亥子丑};
  \node[font=\normalsize\bfseries, green!60!black] at (0:2.8)   {东方木};
  \node[font=\normalsize\bfseries, green!60!black] at (0:2.0)   {寅卯辰};
  \node[font=\normalsize\bfseries, red!60!black]   at (270:2.8) {南方火};
  \node[font=\normalsize\bfseries, red!60!black]   at (270:2.0) {巳午未};
  \node[font=\normalsize\bfseries, orange!60!black] at (180:2.8) {西方金};
